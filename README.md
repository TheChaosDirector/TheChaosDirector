...
| **concentrated** | Daily allocation like portfolio, but **few fat bets** (top-k names, higher per-name caps) aiming to **beat SPY**. Separate champion/artifacts. Alpaca not wired until it passes the referee. |
